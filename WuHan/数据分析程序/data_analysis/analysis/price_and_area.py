...
ax.set_title(f"{CITY_NAME}各区域二手房平均单价",fontsize=18)
mean_unitprice.plot(kind="bar",fontsize=12)
#plt.savefig('analysis\\picture\\mean_price.jpg')
#plt.show()
...
ax = fig.add_subplot(111)
ax.set_ylabel("单价(元/平米)",fontsize=14)
ax.set_title(f"{CITY_NAME}各区域二手房单价箱线图",fontsize=18)
...
ax.set_title(f"{CITY_NAME}各区域二手房总价箱线图",fontsize=18)
...
ax.set_title(f"{CITY_NAME}各区域二手房平均建筑面积",fontsize=18)
...
ax1.set_title(f"{CITY_NAME}各区域二手房平均单价",fontsize=18)
ax2 = fig.add_subplot(2,1,2)
ax2.set_ylabel("建筑面积(㎡)",fontsize=14)
ax2.set_title(f"{CITY_NAME}各区域二手房平均建筑面积",fontsize=18)
...
ax.set_title(f"{CITY_NAME}各区域二手房房源数量",fontsize=18)
...
ax = fig.add_subplot(111)
ax.set_ylabel("单价(元/平米)",fontsize=14)
ax.set_title(f"{CITY_NAME}二手房单价最高Top20",fontsize=18)
...
fig = plt.figure(figsize=(12,7))
ax = fig.add_subplot(111)
ax.set_title(f"{CITY_NAME}二手房总价与建筑面积散点图",fontsize=18)
...
fig = plt.figure(figsize=(12,7))
ax = fig.add_subplot(111)
ax.set_title(f"{CITY_NAME}二手房单价与建筑面积散点图",fontsize=18)
